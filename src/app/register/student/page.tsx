    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50">
        <div className="bg-white rounded-xl shadow p-6 max-w-md text-center">
          ...
          <p className="text-gray-700 mb-4">Save your MIS ID: <strong>{result.misId}</strong></p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input value={form.mname} onChange={(e) => setForm({ ...form, mname: e.target.value })} className="w-full border rounded px-3 py-2" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="date" required value={form.dob} onChange={(e) => setForm({ ...form, dob: e.target.value })} className="w-full border rounded px-3 py-2" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Gender *</label>
              <select required value={form.gender} onChange={(e) => setForm({ ...form, gender: e.target.value })} className="w-full border rounded px-3 py-2">
            ...
            <div>
              ...
              <input value={form.phno} onChange={(e) => setForm({ ...form, phno: e.target.value })} className="w-full border rounded px-3 py-2" />
            </div>
            <div>
          ...
          <div>
            ...
            <input value={form.secQuest} onChange={(e) => setForm({ ...form, secQuest: e.target.value })} placeholder="e.g. Mother's maiden name" className="w-full border rounded px-3 py-2" />
          </div>
          <div>
